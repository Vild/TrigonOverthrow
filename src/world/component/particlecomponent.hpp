...
struct ParticleComponent : public Component<ParticleComponent> {
	...
	void addEmitter(glm::vec3 dir, int nrOfParticles) { 
		...
		std::vector<Vertex> _vertices = {
			Vertex{ glm::vec3(-1, -1, 0),	glm::vec3(0,0, -1), glm::vec3(0.3,0.5,0.3),		glm::vec2(0, 0) }, // Pos, normal, color, uv.
			Vertex{ glm::vec3(-1, 1, 0),	glm::vec3(0,0, -1),	glm::vec3(0.3, 0.5, 0.3),	glm::vec2(1, 0) },
			Vertex{ glm::vec3(1, 1, 0),		glm::vec3(0,0, -1),	glm::vec3(0.3, 0.5, 0.3),	glm::vec2(0, 1) },
			Vertex{ glm::vec3(1, -1, 0),	glm::vec3(0,0, -1),	glm::vec3(0.3, 0.5, 0.3),	glm::vec2(1, 1) },
		};
