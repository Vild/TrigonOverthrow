...
enum CompileCommand {
	Compile = "g++ -c -std=c++14 -O3 -ggdb -Wall -Werror -Wno-maybe-uninitialized -Wno-unused-but-set-variable -Wno-unused-function -fdiagnostics-color=always -fopenmp -I/usr/include/bullet/ $in -o $out",
